    ...
    <div class="header">
      <div class="inter">
        ...
        <div class="search-box">
          <el-input class="search_input" clearable @keydown.native="doSearch" v-model="searchText" placeholder="请输入内容" size="small " prefix-icon="iconfont icon-search">
          </el-input>
                ...
                <ul>
                  <li class="nav-user-avatar">
                    <div><span class="avatar"
                        :style="user.header ? 'background-image: url('+user.header+');':'background-image: url(https://coolmall-oss.oss-cn-hangzhou.aliyuncs.com/2020-12-18/01e615a1-9cc9-4c08-8686-30550325a8a4_logo.png);'"></span>
                    </div>
                    <p class="name">{{user.username}}</p>
                  </li>
                  <li>
                    <router-link :to="{name:'ShoppingCart'}" class="nav-user-list-item">购物车({{carts.length}})</router-link>
                  </li>
                  <li>
                    <router-link :to="{name:'Order'}" class="nav-user-list-item">我的订单</router-link>
                  </li>
                  <li>
                    <router-link :to="{name:'Information'}" class="nav-user-list-item">账户资料</router-link>
                  </li>
                  <li>
                    <router-link :to="{name:'Address'}" class="nav-user-list-item">收货地址</router-link>
                  </li>
